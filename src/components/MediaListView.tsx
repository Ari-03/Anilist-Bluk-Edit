            ...
            >
              ...
              {viewMode === 'grid' ? (
                  ...
                  <div className="aspect-[3/4] relative bg-gray-200 dark:bg-gray-700">
                    {entry.media?.coverImage?.large ? (
                      <Image
                        ...
                        loading="lazy"
                        placeholder="blur"
                        blurDataURL="data:image/jpeg;base64,"
                      />
                    ) : (
                  ...
                  {/* Content */}
                    ...
                    {editingEntry === entry.id ? (
                      ...
                      // Normal Display for Grid View
                                            <div className="text-xs text-gray-500 dark:text-gray-400 flex flex-col flex-grow">
                                                <div>
                                                    ...
                                                    {entry.media?.format && (
                                                        <div className="mt-1">{entry.media.format}</div>
                                                    )}
                                                </div>
                ...
                <div className="flex items-center gap-4">
                  {/* Cover Thumbnail */}
                  <div className="w-12 h-16 bg-gray-200 dark:bg-gray-700 rounded overflow-hidden flex-shrink-0 relative">
                    {entry.media?.coverImage?.medium ? (
                      ...
                      <DefaultCover className="w-full h-full rounded" size="small" />
                    )}
                  </div>
